...
public:
  ...
  __DEVICE__ void ElectricField(const double x, const double y, const double z, double& ex, double& ey, double& ez, MediumGPU * &medium, int& status) const;
    /// Check if a point is inside the user area.
  __DEVICE__ bool IsInArea(const double x, const double y, const double z) const;
