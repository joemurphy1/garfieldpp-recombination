...
__device__ void WeightingField(const double x, const double y, const double z, double& wx, double& wy, double& wz, size_t label);
...
double** m_wpot = nullptr;
  ...
  __device__
  int Field(const double x, const double y, const double z, double& fx,double& fy, double& fz, int& iel,const double* potentials, const int numPotentials) const;


    /// Interpolate the field in a curved quadratic tetrahedron.
  __device__ static void Field13(const double v[10], const double t[4],double jac[4][4], const double det, double& ex, double& ey, double& ez);
