...
int main(int argc, char * argv[]) {
  ...
  // - - - - - - - - - - - - - - - - - -
  // read from Magboltz logfiles - this information is not saved in the gastable - also uncertainties are not saved in gastable
  const int nef_0007mbar = 15;
  std::vector<double> ef_0007mbar    = {100, 148.348, 220.071, 326.471, 484.313, 718.468, 1065.83, 1581.14, 2345.59, 3479.63, 5161.96, 7657.65, 11360, 16852.3, 25000}; // units: V/cm
  std::vector<double> ee_0007mbar    = {1.6898, 2.3188, 3.0607, 3.8370, 4.6023, 5.4482, 6.4786, 7.8224, 9.7010, 12.5488, 17.2406, 25.7509, 43.9548, 97.8900, 384.3224}; // units: eV
  ...
  TGraph * gr_ve_0007mbar = new TGraph(nE_0007mbar,    &efields_0007mbar[0],    &ve_0007mbar[0]);
  TGraph * gr_ve_1013mbar = new TGraph(nE_1013mbar, &efields_1013mbar[0], &ve_1013mbar[0]);
  ...
  TGraph * gr_ee_0007mbar = new TGraph(nef_0007mbar,    &ef_0007mbar[0],    &ee_0007mbar[0]);
  TGraph * gr_ee_1013mbar = new TGraph(nef_1013mbar, &ef_1013mbar[0], &ee_1013mbar[0]);
