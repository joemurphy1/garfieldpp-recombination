...
int main(int argc, char * argv[]) {
  ...
  // Set the Extrapolation: allowed strings: "constant", "linear", "exponential" - default = linear
  ...
  TGraph * gr_al_0007mbar = new TGraph(nE_0007mbar,    &efields_0007mbar[0],    &al_0007mbar[0]);
  TGraph * gr_al_1013mbar = new TGraph(nE_1013mbar,    &efields_1013mbar[0],    &al_1013mbar[0]);
  ...
  const int npoints = std::round(xmax_log - xmin_log)*100; // 100 datapoints / decade
  ...
  for(int i=0; i<npoints; ++i) {
    double alpha = 0.;
    // 0007mbar default
    gas_0007mbar.ElectronTownsend(xrange_lin[i], 0, 0, 0, 0, 0, alpha); // ey,ez,bx,by,bz = 0
    alpha = alpha / density_0007mbar; // alpha/N 
    al_0007mbar_smooth.push_back(alpha);
    // 0007mbar constant
    gas_0007mbar_cte.ElectronTownsend(xrange_lin[i], 0, 0, 0, 0, 0, alpha); // ey,ez,bx,by,bz = 0
    alpha = alpha / density_0007mbar; // alpha/N 
    al_0007mbar_cte.push_back(alpha);
    // 0007mbar linear
    gas_0007mbar_lin.ElectronTownsend(xrange_lin[i], 0, 0, 0, 0, 0, alpha); // ey,ez,bx,by,bz = 0
    alpha = alpha / density_0007mbar; // alpha/N 
    al_0007mbar_lin.push_back(alpha);
    // 0007mbar exponential
    gas_0007mbar_exp.ElectronTownsend(xrange_lin[i], 0, 0, 0, 0, 0, alpha); // ey,ez,bx,by,bz = 0
    alpha = alpha / density_0007mbar; // alpha/N 
  ...
  TGraph * gr_al_0007mbar_smooth = new TGraph(npoints,    &xrange_lin[0],    &al_0007mbar_smooth[0]);
  TGraph * gr_al_1013mbar_smooth = new TGraph(npoints,    &xrange_lin[0],    &al_1013mbar_smooth[0]);
  gr_al_0007mbar_smooth->SetLineWidth(2); gr_al_0007mbar_smooth->SetLineColor(kOrange+7); 
  gr_al_1013mbar_smooth->SetLineWidth(2); gr_al_1013mbar_smooth->SetLineColor(kOrange-3);
  
  // constant
  TGraph * gr_al_0007mbar_cte = new TGraph(npoints,    &xrange_lin[0],    &al_0007mbar_cte[0]);
  TGraph * gr_al_1013mbar_cte = new TGraph(npoints,    &xrange_lin[0],    &al_1013mbar_cte[0]);
  gr_al_0007mbar_cte->SetLineWidth(2); gr_al_0007mbar_cte->SetLineColor(kOrange+7); gr_al_0007mbar_cte->SetLineStyle(7);
  gr_al_1013mbar_cte->SetLineWidth(2); gr_al_1013mbar_cte->SetLineColor(kOrange-3); gr_al_1013mbar_cte->SetLineStyle(7);
  // linear
  TGraph * gr_al_0007mbar_lin = new TGraph(npoints,    &xrange_lin[0],    &al_0007mbar_lin[0]);
  TGraph * gr_al_1013mbar_lin = new TGraph(npoints,    &xrange_lin[0],    &al_1013mbar_lin[0]);
  gr_al_0007mbar_lin->SetLineWidth(2); gr_al_0007mbar_lin->SetLineColor(kOrange+7); gr_al_0007mbar_lin->SetLineStyle(9);
  gr_al_1013mbar_lin->SetLineWidth(2); gr_al_1013mbar_lin->SetLineColor(kOrange-3); gr_al_1013mbar_lin->SetLineStyle(9);
  // exponential
  TGraph * gr_al_0007mbar_exp = new TGraph(npoints,    &xrange_lin[0],    &al_0007mbar_exp[0]);
  TGraph * gr_al_1013mbar_exp = new TGraph(npoints,    &xrange_lin[0],    &al_1013mbar_exp[0]);
  gr_al_0007mbar_exp->SetLineWidth(2); gr_al_0007mbar_exp->SetLineColor(kOrange+7); gr_al_0007mbar_exp->SetLineStyle(10);
  gr_al_1013mbar_exp->SetLineWidth(2); gr_al_1013mbar_exp->SetLineColor(kOrange-3); gr_al_1013mbar_exp->SetLineStyle(10);
  ...
  for (i = 0; i < nE_0007mbar; ++i) {
    efields_0007mbar_Td.push_back( efields_0007mbar[i] / density_0007mbar * 1E17);
  }
  for (i = 0; i < nE_1013mbar; ++i) {
    efields_1013mbar_Td.push_back( efields_1013mbar[i] / density_1013mbar * 1E17);
  }
  // Make new TGraphs
  TGraph * gr_al_Td_0007mbar = new TGraph(nE_0007mbar,    &efields_0007mbar_Td[0],    &al_0007mbar[0]);
  TGraph * gr_al_Td_1013mbar = new TGraph(nE_1013mbar,    &efields_1013mbar_Td[0],    &al_1013mbar[0]);
  ...
  // Make new TGraphs
  TGraph * gr_al_Td_0007mbar_smooth = new TGraph(npoints,    &xrange_lin_td_0007mbar[0],    &al_0007mbar_smooth[0]);
  TGraph * gr_al_Td_1013mbar_smooth = new TGraph(npoints,    &xrange_lin_td_1013mbar[0],    &al_1013mbar_smooth[0]);
  gr_al_Td_0007mbar_smooth->SetLineWidth(2); gr_al_Td_0007mbar_smooth->SetLineColor(kOrange+7); 
  gr_al_Td_1013mbar_smooth->SetLineWidth(2); gr_al_Td_1013mbar_smooth->SetLineColor(kOrange-3); 

  // constant
  TGraph * gr_al_Td_0007mbar_cte = new TGraph(npoints,    &xrange_lin_td_0007mbar[0],    &al_0007mbar_cte[0]);
  TGraph * gr_al_Td_1013mbar_cte = new TGraph(npoints,    &xrange_lin_td_1013mbar[0],    &al_1013mbar_cte[0]);
  gr_al_Td_0007mbar_cte->SetLineWidth(2); gr_al_Td_0007mbar_cte->SetLineColor(kOrange+7); gr_al_Td_0007mbar_cte->SetLineStyle(7);
  gr_al_Td_1013mbar_cte->SetLineWidth(2); gr_al_Td_1013mbar_cte->SetLineColor(kOrange-3); gr_al_Td_1013mbar_cte->SetLineStyle(7);
  // linear
  TGraph * gr_al_Td_0007mbar_lin = new TGraph(npoints,    &xrange_lin_td_0007mbar[0],    &al_0007mbar_lin[0]);
  TGraph * gr_al_Td_1013mbar_lin = new TGraph(npoints,    &xrange_lin_td_1013mbar[0],    &al_1013mbar_lin[0]);
  gr_al_Td_0007mbar_lin->SetLineWidth(2); gr_al_Td_0007mbar_lin->SetLineColor(kOrange+7); gr_al_Td_0007mbar_lin->SetLineStyle(9);
  gr_al_Td_1013mbar_lin->SetLineWidth(2); gr_al_Td_1013mbar_lin->SetLineColor(kOrange-3); gr_al_Td_1013mbar_lin->SetLineStyle(9);
  // exponential
  TGraph * gr_al_Td_0007mbar_exp = new TGraph(npoints,    &xrange_lin_td_0007mbar[0],    &al_0007mbar_exp[0]);
  TGraph * gr_al_Td_1013mbar_exp = new TGraph(npoints,    &xrange_lin_td_1013mbar[0],    &al_1013mbar_exp[0]);
  gr_al_Td_0007mbar_exp->SetLineWidth(2); gr_al_Td_0007mbar_exp->SetLineColor(kOrange+7); gr_al_Td_0007mbar_exp->SetLineStyle(10);
  gr_al_Td_1013mbar_exp->SetLineWidth(2); gr_al_Td_1013mbar_exp->SetLineColor(kOrange-3); gr_al_Td_1013mbar_exp->SetLineStyle(10);
